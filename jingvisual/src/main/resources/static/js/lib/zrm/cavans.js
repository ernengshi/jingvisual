...
Triangle.prototype.drawText = function(ctx) {
    ...
    ctx.fillStyle = "#fff";
    //从坐标点(50,50)开始绘制文字
    ctx.fillText("可靠稳定",50, -50);    
    ctx.fillText("数据安全",50, 50);
    ctx.fillText("应用托管",-100, -50);
    ctx.fillText("资源监控",-100, 50);
}
...
var icosahedron = new function() {
    ...
    var c, ctx;
    var size =document.getElementById("aa").offsetWidth;
    ...
    function renderText() {  
            new Triangle(new Vector3(10, 10, 10), new Vector3(0, 0, 0), new Vector3(0, 0, 0), this.scale).drawText(ctx); 
    }
