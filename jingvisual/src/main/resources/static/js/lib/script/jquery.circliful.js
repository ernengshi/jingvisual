		...
		return this.each(function() {
			...
			if ($(this).data('text') != undefined) {
				...
				if ($(this).data('type') != undefined) {
					...
					if (type == 'half') {
						$(this).append(
								'<span class="circle-text-half">' + icon + text
										+ '</span>');
						...
						$(this).append(
								'<span class="circle-text">' + icon + text
										+ '</span>');
			...
			if ($(this).data('info') != undefined) {
				...
				if ($(this).data('type') != undefined) {
					...
					if (type == 'half') {
						$(this).append(
								'<span class="circle-info-half">' + info
										+ '</span>');
					...
					$(this).append(
							'<span class="circle-info">' + info + '</span>');
					$(this).find('.circle-info').css({
						'line-height' : (dimension * 1.25) + 'px',
					});
				}
			...
			function animate(current) {
				...
				context.beginPath();
				context.arc(x, y, radius, -(quart), ((circ) * current) - quart,
						false);
